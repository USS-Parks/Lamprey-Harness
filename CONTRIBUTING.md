...
- `electron/services/` — business logic (provider registry + multi-provider client, SQLite store, MCP manager, skill watcher, artifact sandbox, keychain, tray, updater).
