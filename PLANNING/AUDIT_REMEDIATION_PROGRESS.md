...
|---|-------|----------|--------|
| 1 | Hygiene & quick wins | DOC-4, STRUCT-1/2, DEP-1/2/3, CI-3 | Pending |
...
_Append one `## Prompt N — Title — Done (YYYY-MM-DD)` block per landed prompt, with Files / Verification / Acceptance, per the house style in CODEX_TOOLSET_PARITY_PROGRESS.md._
