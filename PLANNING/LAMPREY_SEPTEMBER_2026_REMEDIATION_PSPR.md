...
| [x] SR-34 | Run final source acceptance and close the finding ledger | Gate 8 passes on exact candidate; all SA IDs linked to repair or explicit approved disposition; rerun source probes at final source; no P1 silently deferred; DEVLOG/commits/skip ledger reconciled |
...
| [x] SR-36B | Allow bounded transfers of the measured release artifacts | Measured transfer and largest artifact size recorded; connect, stalled-transfer and total deadlines remain bounded; Bucket HTTP/hash and producer regressions pass; candidate committed and pushed before tag |
...
SR-38 leftover (2026-09-07): README download table and New-in copy now point at GitHub v0.32.0. That does not close SR-38. CDN/TL-W4, packaged install smoke (SR-37), and storage/worktree inventory remain open.
