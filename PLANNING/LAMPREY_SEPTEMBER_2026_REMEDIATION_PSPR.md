...
| [ ] SR-18A | Repair packaged plugin skill and slash-command subscriptions (post-baseline SA-31) | Production Electron bundle loads plugin contributions and responds to enable/disable without unresolved relative requires; existing loader suites pass |
