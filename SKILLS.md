...
- **Watch the char count.** The editor warns at 4000 characters because long skills displace conversation history — and context windows vary widely by model (e.g. Gemma ~131K, Qwen / OpenRouter ~262K, DeepSeek V4 up to 1M tokens).
